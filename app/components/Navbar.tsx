...
const Navbar = () => {
  return (
    <header className='sticky top-0 z-40 border-b border-transparent bg-opacity-50 backdrop-blur-[8px] backdrop-filter transition-opacity duration-200 ease-in-out bg-white animate-header-slide-down-fade'>
